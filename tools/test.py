...
def main():
    ...
    #print(cfg.data.test)
    #cfg.data.test.ann_file = '/home/users/xingyu.zhang/workspace/SparseDrive/data/infos/nuscenes_infos_train.pkl'
    #cfg.data.test.eval_config.ann_file = '/home/users/xingyu.zhang/workspace/SparseDrive/data/infos/nuscenes_infos_train.pkl'
    #print("---")
