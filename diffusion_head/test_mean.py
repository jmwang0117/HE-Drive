...
checkpoint = torch.load('/home/users/xingyu.zhang/workspace/SparseDrive/diffusion_head/checkpoint_final_new_normal.pth')
...
# 可以将生成的轨迹保存为文件
with open('generated_trajs_0918_all.pkl', 'wb') as f:
